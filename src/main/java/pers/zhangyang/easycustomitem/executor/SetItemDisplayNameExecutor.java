...
public class SetItemDisplayNameExecutor extends ExecutorBase {
    public SetItemDisplayNameExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.setItemDisplayName");
        MessageUtil.sendMessageTo(sender,list);
    }
}
