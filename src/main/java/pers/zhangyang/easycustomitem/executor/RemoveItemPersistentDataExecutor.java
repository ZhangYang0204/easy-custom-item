...
public class RemoveItemPersistentDataExecutor extends ExecutorBase {
    public RemoveItemPersistentDataExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.removeItemPersistentData");
        MessageUtil.sendMessageTo(sender,list);
    }
}
