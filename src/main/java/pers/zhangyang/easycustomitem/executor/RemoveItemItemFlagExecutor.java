...
public class RemoveItemItemFlagExecutor extends ExecutorBase {
    public RemoveItemItemFlagExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.removeItemFlag");
        MessageUtil.sendMessageTo(sender,list);
    }
}
