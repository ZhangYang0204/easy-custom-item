...
public class AddItemItemFlagExecutor extends ExecutorBase {
    public AddItemItemFlagExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.addItemFlag");
        MessageUtil.sendMessageTo(sender,list);
    }
}
