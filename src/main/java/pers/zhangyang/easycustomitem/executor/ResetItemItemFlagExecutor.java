...
public class ResetItemItemFlagExecutor extends ExecutorBase {
    public ResetItemItemFlagExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.resetItemFlag");
        MessageUtil.sendMessageTo(sender,list);
    }
}
