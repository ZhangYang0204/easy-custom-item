...
public class ResetItemLoreExecutor extends ExecutorBase {
    public ResetItemLoreExecutor(@NotNull CommandSender sender, String commandName, @NotNull String[] args) {
    ...
    protected void run() {
       ...
       itemStack.setItemMeta(itemMeta);
        ...
        List<String> list = MessageYaml.INSTANCE.getStringList("message.chat.resetItemLore");
        MessageUtil.sendMessageTo(sender,list);
    }
}
